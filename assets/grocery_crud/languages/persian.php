<?php  
	...
	$lang['list_more'] = 'بیشتر';

	/* Added in version 1.5.6 */
	$lang['list_search_column'] = 'جستجو {column_name}';

	/* Added in version 1.5.8 */
	$lang['alert_delete_multiple'] = 'ایا میخواهید تعداد {items_amount} ردیف را حذف کنید؟';

	$lang['alert_delete_multiple_one'] = 'آیا میخواهید 1 ردیف را پاک کنید؟';



	/* Added in version 1.6.1 */
	$lang['list_clone'] = 'دوبل';
